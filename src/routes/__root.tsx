...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Explore the FutureTech Group technology ecosystem in interactive 3D.",
      },
      { name: "author", content: "FutureTech Group" },
      { property: "og:title", content: "FutureTech Group" },
      { property: "og:description", content: "Interactive corporate technology ecosystem portal." },
