  ...
  categories: [
    ...
    cat(
      ...
      [
        ...
        {
          name: "TraceSight",
          tagline: "Logistics flow intelligence",
          description:
            "Ceiling-mounted sensor network that tracks pallets, vehicles and people through a facility to expose real congestion.",
          features: [
            "Anonymised multi-object tracking",
            "Automatic dock and aisle dwell analytics",
            "Congestion forecasting 30 minutes ahead",
            "Digital-twin replay of any past shift",
          ],
          benefits: [
            "Recovers 11% of usable dock capacity on average",
            "Finds bottlenecks without manual time studies",
            "Meets privacy rules through on-sensor anonymisation",
          ],
          useCases: [
            "Distribution-centre throughput optimisation",
            "Port and terminal yard planning",
            "Airport ground-handling coordination",
          ],
          technologies: ["ROS 2", "Kalman filtering", "TimescaleDB", "WebGL"],
          specifications: {
            Coverage: "1 sensor per 400 m²",
            "Tracking accuracy": "± 15 cm",
            "Forecast horizon": "30 minutes",
            Privacy: "On-sensor anonymisation",
            Retention: "90 days of replay",
          },
          model3D: model("lattice", ACCENT, [
            [
              "hs-sensor",
              "Fusion Sensor",
              "Combined depth and RGB module covering 400 m² from a single ceiling mount.",
              [0, 1.2, 0.3],
            ],
            [
              "hs-track",
              "Tracking Engine",
              "Multi-hypothesis tracker maintaining identity across overlapping sensor fields.",
              [1.3, 0.1, 0.3],
            ],
            [
              "hs-twin",
              "Digital Twin",
              "Time-indexed replay layer for reconstructing any past shift second by second.",
              [-1.2, -0.7, 0.4],
            ],
          ]),
        },
